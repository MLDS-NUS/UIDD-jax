...
sys.path.append('../..')
from onsagernet.dynamics import OnsagerNet, OnsagerNetFD
from onsagernet.new_dynamics import OnsagerNetHD,  OnsagerNetHD2
from onsagernet.new_models import DiffusionConstant, PotentialResMLP_scale
...
def get_filter_spec(model) -> Any:
    ...
    # 然后手动将 'name' 设为 False，表示 static
    filter_spec = eqx.tree_at(
        lambda m: m.J,  # 这里的路径是 model.name
        filter_spec,
